...
export const metadata: Metadata = {
  ...
  description:
    "Explore the  best content creation resources - blogs,  courses, books, ebooks, and more to improve your skills and stay ahead of trends.",
};
