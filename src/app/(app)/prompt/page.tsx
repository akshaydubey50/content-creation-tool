...
export default function Prompt() {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-[79vh] space-y-4">
            <h2 className="font-bold text-5xl md:text-6xl inline-block text-center text-transparent bg-gradient-to-b from-DarkOrange to-white bg-clip-text pb-4">Coming Soon</h2>
            <button
