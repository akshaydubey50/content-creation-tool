...
export default function Experts() {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-[79vh] space-y-4 ">
            <h2 className="font-bold text-5xl md:text-6xl text-center pb-4 inline-block text-transparent bg-gradient-to-b from-DarkOrange to-white bg-clip-text">Coming Soon</h2>
