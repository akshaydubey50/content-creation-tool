    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen} >
            <DialogContent className="bg-white border-white text-black rounded-xl w-11/12 md:w-full">
                <DialogHeader>
                    <DialogTitle className='font-bold text-2xl pb-3 '>Subscribe to our newsletter</DialogTitle>
                    <DialogDescription className='font-medium text-base'>
                       <span className='pr-1'>
                            Discover the best content creation  
                       </span>
                         <span className='font-bold'>
                         tools, news, resources, memes, and jobs
                        </span>
                        <span className='pl-1'>
                         — sent to your inbox every Tuesday
                        </span>
                    </DialogDescription>
                </DialogHeader>
