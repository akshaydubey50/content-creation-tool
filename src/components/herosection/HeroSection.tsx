            ...
            <div className="flex-1">
              <div className="flex space-x-2  md:space-x-4 lg:space-x-8 xl:space-x-12 ">
                <div className="flex flex-col place-items-center  space-y-4 cursor-pointer">
                  <button
                    className={`text-tags bg-opacity-50 rounded-full p-3 xl:p-6 ${isAllFilled ? "bg-gray-200" : "bg-gray-300"
                ...
                <div className="flex flex-col place-items-center  space-y-4 cursor-pointer">
                  <button
                    className={`text-tags bg-opacity-50 rounded-full p-3 xl:p-6 ${isBookMarkFilled ? "bg-gray-200" : "bg-gray-300"
                      } hover:bg-opacity-75 focus:outline-none`}
                ...
                <div className="flex flex-col place-items-center  space-y-4 cursor-pointer">
                  <button
                    className={`text-tags bg-opacity-50 rounded-full p-3 xl:p-6 ${isVerifiedFilled ? "bg-gray-200" : "bg-gray-300"
                      } hover:bg-opacity-75 focus:outline-none`}
                ...
                <div className="flex flex-col place-items-center  space-y-4 cursor-pointer">
                  <button
                    className={`text-tags bg-opacity-50 rounded-full p-3 xl:p-6 ${isSearchFilled ? "bg-gray-200" : "bg-gray-300"
                      } hover:bg-opacity-75 focus:outline-none`}
