  ...
  return (
    <>
      <main className="bg-light-gray  p-10 md:px-20 md:py-16 md:mb-12">
        <BreadCrumb />
        <div
          className="affiliate-tool-container flex-col  
        space-y-8 md:flex lg:flex-row flex-1    lg:space-x-20 my-12"
        >
          <div
            className="aftl-left-section border border-black border-solid
           rounded-t-xl lg:w-1/2 "
          >
            <Image
              alt="logo bannero"
              loading="lazy"
          ...
          <div className="aftl-right-section lg:w-1/2">
            <div className="flex flex-col flex-1 space-y-10 mb-6">
              ...
              <p className="ml-0 text-2xl">{description}</p>
            </div>
